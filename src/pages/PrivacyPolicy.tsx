...
export default function PrivacyPolicy() {
  const { appName, companyName, contactEmail, updateDate, effectiveDate, sections } = privacyData
  ...
  const renderList = (list: ListItem) => {
    ...
    return (
      <div>
        ...
        <ul className={`${listClass} list-inside ml-4 mt-3 space-y-1`}>
  ...
  return (
    <div className="relative min-h-screen py-16 md:py-24 pt-24 md:pt-24">
      <div className="mx-auto max-w-4xl px-6">
        <h1 className="text-4xl md:text-5xl font-bold mb-4 text-foreground">隐私政策</h1>
